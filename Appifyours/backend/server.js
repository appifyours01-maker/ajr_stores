...
// MongoDB connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/ajr_stores_app', {
...
app.get('/api/app-config', async (req, res) => {
  try {
    ...
    const config = {
      adminId: '6a323dda8bc32f61974253b9',
      shopName: 'AJR Stores',
...
app.listen(PORT, () => {
  console.log(`AJR Stores Backend Server running on port ${PORT}`);
});
module.exports = app;
